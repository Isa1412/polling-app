package com.github.isa1412.polls.service;

import com.github.isa1412.polls.exception.BadRequestException;
import com.github.isa1412.polls.exception.ResourceNotFoundException;
import com.github.isa1412.polls.model.*;
import com.github.isa1412.polls.payload.PagedResponse;
import com.github.isa1412.polls.payload.PollRequest;
import com.github.isa1412.polls.payload.PollResponse;
import com.github.isa1412.polls.payload.VoteRequest;
...
import com.github.isa1412.polls.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currenUser) {
        ...
        Vote userVote = null;
        if (currenUser != null) {
            userVote = voteRepository.findByUserIdAndPollId(currenUser.getId(), pollId);
        }
